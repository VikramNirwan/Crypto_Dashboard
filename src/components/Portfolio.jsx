...
export const Portfolio = () => {
  ...
  return (
    <>
      <div className="bg-white  backdrop-blur-md border border-gray-100 rounded-lg shadow-lg mx-2">
        <div className="mt-3">
          {" "}
          <span className="text-lg text-black font-semibold pt-6 ml-8">
            Portfolio{" "}
          </span>
          <span className="text-gray lg:ml-[80px] xl:ml-[120px] text-sm md:ml-[70px] sm:ml-[10px] ml-[50px]">
            Total Value
          </span>{" "}
        ...
        <div className="xl:w-[240px] xl:h-[180px] md:w-[240px] md:h-[200px] xl:ml-[100px] md:ml-[70px] w-[230px] h-[170px] ml-[60px] -mt-[15px]">

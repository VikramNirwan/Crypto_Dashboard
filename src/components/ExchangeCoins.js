...
export const ExchangeCoins = () => {
  ...
  return (
    <div className="px-4 py-4 font-body bg-white  backdrop-blur-md rounded-lg border border-gray-200 shadow-lg items-center mx-2">
      ...
      <div className="flex flex-row mt-8">
        <div className="pr-4 items-center">
          <div className="flex my-1 content-center items-center py-1 px-2 lg:ml-3">
            ...
            <select
              ...
              className="lg:pl-8 w-[130px] h-[2rem] font-semibold rounded-lg p-1 text-black bg-gray-200  backdrop-blur-md focus:ring-2 focus:outline-none px-5 inline-flex cursor-pointer"
            >
              {coin &&
          ...
          <div className="flex my-2 content-center items-center py-1 px-2 lg:ml-3">
            ...
            <select
              ...
              className="lg:pl-8 w-[130px] h-[2rem] font-semibold rounded-lg text-black bg-gray-200 backdrop-blur-md focus:ring-2 focus:outline-none px-5 items-center cursor-pointer"
            >
              {coin &&
                Object.values(coin).map((d, k) => (
                  <option key={k} value={d.value} className="text-gray-600">
        ...
        <div className="-mt-5 mr-3 lg:pl-10">
          <div>
            <label className="text-xs text-black">Enter value</label>
            <div className="mr-[90px] lg:w-[90px] md:w-full sm:w-[90px] w-full py-2">
              <input
                type="number"
                className="appearance-none block w-full bg-gray-200  backdrop-blur-md text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 rounded border border-gray-400 px-3 py-1 text-sm outline-none pt-2 pb-2"
                placeholder=""
                value={text1 || ""}
      ...
      <div className="text-center mt-4 pb-4">
        <button
          onClick={() => convert()}
          className="bg-blue-700  backdrop-blur-md rounded-lg text-sm py-2 px-6 text-white font-semibold"
        >
          Exchange
        </button>
      </div>

...
const SearchInput = ({ handleSearch }) => {
  ...
  return (
    <>
      <form className="flex pl-4 w-full font-body bg-gray-100 ">
        <div className="flex flex-grow rounded-sm">
          <div className="flex flex-grow items-center">
            <span className="absolute text-[13px] lg:text-[13px] sm:text-[12px] md:text-[14px] ml-6 ">
              <svg
            ...
            <input
              ...
              className="flex border border-gray-100 focus:ring-1 bg-white 
               md:text-md sm:text-md w-full pl-14 py-2 pr-2 p rounded-lg overflow-hidden focus-within:shadow-none outline-none sm:items-center mr-2 ml-0 mt-2"
      ...
      <div className="flex bg-gray-100">
        <span className="flex rounded-lg">
          <select
            ...
            ref={currencyRef}
            className="border border-gray-100 text-black outline-none font-body pr-3 pl-2 rounded-lg w-[90px] md:w-[90px] sm:w-[90px] cursor-pointer backdrop-blur-md ml-2 mt-2"
          >
